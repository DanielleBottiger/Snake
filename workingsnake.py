...
class Snake:
    ...
    def drawSelf(self, turtle):
        ...
        if self.crashed:
            if self.nextposition[0] > 250:
                turtle.write("Game Over!", move = False, align = "right", font = ("Arial", 20, "normal"))
                turtle.goto(turtle.xcor(), turtle.ycor()- 12)
                turtle.write("Press Space to play again!", move = False, align = "right", font = ("Arial", 20, "normal"))
            elif self.nextposition[0] < -250:
                turtle.write("Game Over!", move = False, align = "left", font = ("Arial", 20, "normal"))
                turtle.goto(turtle.xcor(), turtle.ycor()- 12)
                turtle.write("Press Space to play again!", move = False, align = "left", font = ("Arial", 20, "normal"))
            elif self.nextposition[1] < -250:
                turtle.goto(turtle.xcor(), turtle.ycor()+ 14)
                turtle.write("Game Over!", move = False, align = "center", font = ("Arial", 20, "normal"))
                turtle.goto(turtle.xcor(), turtle.ycor()- 12)
                turtle.write("Press Space to play again!", move = False, align = "center", font = ("Arial", 20, "normal"))                
            else:
                turtle.write("Game Over!", move = False, align = "center", font = ("Arial", 20, "normal"))
                turtle.goto(turtle.xcor(), turtle.ycor()- 12)
                turtle.write("Press Space to play again!", move = False, align = "center", font = ("Arial", 20, "normal"))
...
class Game():
    ...
    def nextFrame(self):
        ...
        if not self.snake.crashed:
            ...
            self.snake.drawSelf(self.artist)
            self.screen.onkey(self.newGame, "space")
